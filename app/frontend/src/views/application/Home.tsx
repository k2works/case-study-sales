        ...
        <div className="single-view-container">
            ...
            <div className="single-view-content">
                <dl className="info">
                    ...
                    <dd>
                        <a href="#" id="auth-func">在庫機能リリース</a>
                    </dd>
                    <dd>
                        <a href="#" id="auth-func">倉庫マスタ機能リリース</a>
                    </dd>
                    <dd>
                        <a href="#" id="auth-func">棚番マスタ機能リリース</a>
                    </dd>
                    <dt>
                        <span>新機能</span>
                        <time>2025.8.31</time>
                    ...
                    <dd>
                        <a href="#" id="auth-func">回収機能リリース</a>
                    </dd>
                    <dt>
                        <span>新機能</span>
                        <time>2025.6.17</time>
                    ...
                    <dd>
                        <a href="#" id="auth-func">請求機能リリース</a>
                    </dd>
                    <dt>
                        <span>新機能</span>
                        <time>2025.5.1</time>
                    ...
                    <dd>
                        <a href="#" id="auth-func">出荷/売上機能リリース</a>
                    </dd>
                    <dt>
                        <span>新機能</span>
                        <time>2025.3.25</time>
                    ...
                    <dd>
                        <a href="#" id="auth-func">受注機能リリース</a>
                    </dd>
                    <dt>
                        <span>新機能</span>
                        <time>2025.2.15</time>
                    ...
                    <dd>
                        <a href="#" id="auth-func">取引先マスタ機能リリース</a>
                    </dd>
                    <dd>
                        <a href="#" id="auth-func">コードマスタ機能リリース</a>
                    </dd>
                    <dt>
                        <span>新機能</span>
                        <time>2025.1.1</time>
