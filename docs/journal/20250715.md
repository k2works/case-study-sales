...
```
test(WIP): 入金管理
Added comprehensive unit tests to verify `PaymentAccount` creation logic and validation rules, including required fields, default values, and date consistency checks. Updated the domain model to enforce end date validation during instantiation.
```

### 変更されたファイル

- M	app/backend/api/src/main/java/com/example/sms/domain/model/master/payment/account/incoming/PaymentAccount.java
- A	app/backend/api/src/test/java/com/example/sms/domain/model/master/payment/account/incoming/PaymentAccountTest.java
...
```diff
commit f130ce62abe653466b2c03f09796774636734b61
Author: k2works <kakimomokuri@gmail.com>
Date:   Tue Jul 15 18:36:11 2025 +0900
...
index 03989d4c..69bfb892 100644
...
+
         return new PaymentAccount(
                 ...
                 accountName,
@@ -51,4 +59,4 @@ public class PaymentAccount {
                 branchCode
         );
     }
-}
...
+}
diff --git a/app/backend/api/src/test/java/com/example/sms/domain/model/master/payment/account/incoming/PaymentAccountTest.java b/app/backend/api/src/test/java/com/example/sms/domain/model/master/payment/account/incoming/PaymentAccountTest.java
new file mode 100644
index 00000000..873153a5
--- /dev/null
+++ b/app/backend/api/src/test/java/com/example/sms/domain/model/master/payment/account/incoming/PaymentAccountTest.java
@@ -0,0 +1,303 @@
